...
import { AiFillGift, BiMessageAltEdit, BsPlusCircle, RiGalleryLine,AiOutlineSend } from 'react-icons/all'
    ...
    return (
        <div className='message-send-section'>
            ...
            <div className="message-type">
                <input onChange={inputHendle} onKeyPress={(e)=>{
                    if(e.key==="Enter"){
                        sendMessage();
                    }
                }} type="text" name='message' id='message' placeholder='Aa' value={newMessage} className="form-control" />
